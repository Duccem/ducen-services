import { Logger, Primitives, RedisConnection, RedisRepository } from '@ducen/shared';
...
export class RedisFlagRepository extends RedisRepository<Flag> implements FlagRepository {
  constructor(connection: RedisConnection, protected readonly dbRepository: FlagRepository, logger: Logger) {
