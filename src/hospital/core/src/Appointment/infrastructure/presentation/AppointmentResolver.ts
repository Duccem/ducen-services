...
export class AppointmentResolver {
  ...
  async userEnterAppointment(
    @Args('appointmentId') appointmentId: string,
    @Args('whoEnter') whoEnter: string
  ) {
  ...
  async userLeaveAppointment(
    @Args('appointmentId') appointmentId: string,
    @Args('whoLeave') whoLeaver: string
  ) {
  ...
  async getPatientAppointments(
    ...
    return this.queryBus.ask(
      new ListPatientAppointmentsQuery(patientId, pagination.limit, pagination.offset)
    );
  }
}
