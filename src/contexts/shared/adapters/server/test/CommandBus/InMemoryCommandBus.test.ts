import { InternalError } from '@shared/core';
import { CommandHandlers } from '../../src/Command/CommandHandlers';
import { InMemoryCommandBus } from '../../src/Command/InMemoryCommandBus';
