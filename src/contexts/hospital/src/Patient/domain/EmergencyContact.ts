import { Enum, Primitives, StringValueObject } from '@ducen-services/shared';
...
export class ContactName {
  ...
  static fromPrimitives(primitives: Primitives<ContactName>): ContactName {
    return new ContactName(new StringValueObject(primitives.firstName), new StringValueObject(primitives.lastName));
  }
}
