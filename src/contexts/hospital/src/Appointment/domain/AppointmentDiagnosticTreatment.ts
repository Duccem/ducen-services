...
export class AppointmentDiagnosticTreatment {
  ...
  static fromPrimitives(primitive: Primitives<AppointmentDiagnosticTreatment>): AppointmentDiagnosticTreatment {
    return new AppointmentDiagnosticTreatment(
      ...
      primitive.medications.map((medication) => AppointmentDiagnosticTreatmentMedication.fromPrimitives(medication)),
    );
  }
