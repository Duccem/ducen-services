...
import { MongoUserRepository } from './adapters/user.repository';
import { JWTUserService } from './adapters/user.service';
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (conf: any) => new JWTUserService(conf.authKey),
    },
    ...queryHandlers,
    ...commandHandlers,
    {
